...
describe('ReviewsService', () => {
  ...
  beforeEach(async () => {
    ...
    reviewsRepository = module.get<Repository<ReviewsEntity>>(
      getRepositoryToken(ReviewsEntity),
    );
  ...
  it('should update an existing review', async () => {
    ...
    jest
      .spyOn(reviewsRepository, 'save')
      .mockResolvedValue({ ...mockReview, ...updateDto });
