...
describe('ShopsService', () => {
    ...
    it('should update an existing shop', async () => {
        ...
        jest.spyOn(shopRepository, 'save').mockResolvedValue({ ...mockShop, ...updateDto });
    ...
    it('should delete a shop', async () => {
        jest.spyOn(shopRepository, 'delete').mockResolvedValue({ affected: 1 } as any);
    ...
    it('should throw NotFoundException when deleting a non-existent shop', async () => {
        jest.spyOn(shopRepository, 'delete').mockResolvedValue({ affected: 0 } as any);
